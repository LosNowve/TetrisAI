...
class TetrisAI(object):
    ...
    def nextMove(self):
        ...
        _, _, minY, _ = BOARD_DATA.nextShape[0].getBoundingOffsets(0)
        nextY = -minY
        ...
        if BOARD_DATA.nextShape[0].shape in (Shape.shapeI, Shape.shapeZ, Shape.shapeS):
            d1Range = (0, 1)
        elif BOARD_DATA.nextShape[0].shape == Shape.shapeO:
            d1Range = (0,)
        else:
            d1Range = (0, 1, 2, 3)
        ...
        for d0 in d0Range:
            ...
            for x0 in range(-minX, BOARD_DATA.width - maxX):
                ...
                for d1 in d1Range:
                    minX, maxX, _, _ = BOARD_DATA.nextShape[0].getBoundingOffsets(d1)
    ...
    def calcNextDropDist(self, data, d0, xRange):
        ...
        for x0 in xRange:
            ...
            for x, y in BOARD_DATA.nextShape[0].getCoords(d0, x0, 0):
                yy = 0
    ...
    def calculateScore(self, step1Board, d1, x1, dropDist):
        ...
        self.dropDownByDist(step1Board, BOARD_DATA.nextShape[0], d1, x1, dropDist[x1])
        # print(datetime.now() - t1)
